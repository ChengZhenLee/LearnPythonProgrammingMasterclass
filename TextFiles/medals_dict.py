...
def sort_key(d: dict) -> str:
    """Returns the key of the dict element in the list"""
    return d['country']
...
with open(filename, 'w', encoding='utf-8', newline='') as output_file:
    ...
    # extrasaction='ignore' is used to ignore the additional fields in the dict that is not required when writing
    writer.writeheader()
    
    # Write to the csv file line-by-line by iterating
    # for row in medals_table:
    #     writer.writerow(row)

    # Write to the csv file without iterating
