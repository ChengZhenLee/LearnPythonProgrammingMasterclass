...
if __name__ == '__main__':
    # This is composition
    # Each object part is declared all in one object
    # Each object part is destroyed when the main object is destroyed
    ...
    # This is aggregation
    # Each object part is declared independently
    # These objects can be used elsewhere in the program
    new_body = Body()
    new_body.add_tag('h1', 'Aggregation')
    new_body.add_tag('p', "Unlike <strong>composition</strong>, aggregation"
                    " uses existing instances of objects to build up another object.")
    new_body.add_tag('p', "The compound object doesn't actually own the"
                    " objects that it's composed of - if it's destroyed"
