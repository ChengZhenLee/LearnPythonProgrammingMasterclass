...
#     # meds_to_watch.update(interaction) # Update the existing set instead of redeclaring a new one each loop 
#     meds_to_watch |= interaction

meds_to_watch.update(*adverse_interactions) # The '*' unpacks the list
